...
<security:authorize access="isAuthenticated()">
	...
	<display:column><a href="chirp/view.do?messageId=${row.id }"><spring:message code="chirp.view"/></a></display:column>
	
	<display:column><a href="chirp/reply.do?messageId=${row.id }"><spring:message code="chirp.respond" /></a></display:column>
